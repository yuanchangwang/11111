...
func assetsHtmlClashConfigLocalYaml() (*asset, error) {
	path := "assets/html/clash-config-local.yaml"
	name := "assets/html/clash-config-local.yaml"
...
func assetsHtmlShadowrocketHtml() (*asset, error) {
	path := "assets/html/shadowrocket.html"
	name := "assets/html/shadowrocket.html"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
var _bindata = map[string]func() (*asset, error){
	"assets/html/clash-config-local.yaml": assetsHtmlClashConfigLocalYaml,
	...
	"assets/html/shadowrocket.html":       assetsHtmlShadowrocketHtml,
